...
from embedding.word_embedding import embedding_factory, EmbedTypes
...
class AbstractEvaluator(ABC):
    ...
    def set_models(self, active_technique, train_set):
        self.active_technique = active_technique
        if not self.map_exit():
            self.technique = embedding_factory(EmbedTypes[active_technique], train_set)
